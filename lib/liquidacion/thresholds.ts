...
export const CONTRACT_EXPIRY_ROW_CLASSES = {
  normal:     '',
  next_month: 'bg-info/20',        // celeste — primer aviso (vencimiento el mes que viene)
  this_month: 'bg-info/45',        // azul más oscuro — vencimiento este mes
  expired:    'bg-danger/25',      // past due — already expired
} as const
...
export const ALQUILER_AUMENTO_CELL_CLASS = 'bg-warn/45'
