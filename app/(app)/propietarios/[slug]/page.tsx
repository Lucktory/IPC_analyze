      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section className="bg-paper border border-line rounded p-5">
          ...
          <dl className="space-y-3">
            ...
            <div>
              <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">CUIT</dt>
              <dd className="text-[13px] text-ink tabular-nums">{data.cuit}</dd>
            </div>
            <div>
              <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">Cliente desde</dt>
              <dd className="text-[13px] text-ink">{data.desde}</dd>
            </div>
          </dl>
        </section>

        <section className="bg-paper border border-line rounded p-5">
          <h2 className="label-cap mb-4">Cobro y liquidaciones</h2>
          <dl className="space-y-3">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">Comisión</dt>
                <dd className="text-[15px] font-display font-semibold text-ink tabular-nums">{data.comision}%</dd>
              </div>
              <div>
                <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">Ingresos del mes</dt>
                <dd className="text-[15px] font-display font-semibold text-ink tabular-nums">{fmt(data.ingresosMes)}</dd>
              </div>
            </div>
            <div>
              <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">Banco</dt>
              <dd className="text-[13px] text-ink">{data.banco}</dd>
            </div>
            <div>
              <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">Cuenta</dt>
              <dd className="text-[13px] text-ink tabular-nums">{data.cuenta}</dd>
            </div>
            <div>
              <dt className="text-[11px] text-slate uppercase tracking-wider mb-0.5">Alias</dt>
